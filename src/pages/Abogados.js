...
const Abogados = props => {
        ...
        return (
            <div className="mainContentAll">
                <div className="abogadoHero">
                    <img src={abogadoHero} alt="Imagen Abogados"/>
                </div>
                <div className="lawyer-title">
                    <h2 className="font" style={{fontSize:22, fontWeight: "bold"}}>{props.data.contenido.abogados.title} </h2>
